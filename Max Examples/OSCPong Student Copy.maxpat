...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"color" : [ 0.868903, 0.772329, 0.033922, 1.0 ],
					"id" : "obj-12",
					"maxclass" : "newobj",
					"numinlets" : 0,
					"numoutlets" : 0,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 421.0, 296.0, 50.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 421.0, 393.0, 50.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 421.0, 349.0, 99.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 336.0, 393.0, 50.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 266.25, 393.0, 50.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 196.5, 393.0, 50.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 126.75, 393.0, 50.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 57.0, 393.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 57.0, 282.0, 66.0, 23.0 ],
									"style" : "",
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 57.0, 314.0, 32.5, 23.0 ],
									"style" : "",
									"text" : "poll"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 57.0, 349.0, 298.0, 22.0 ],
									"style" : "",
									"text" : "mousestate"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 53.0, 59.0, 538.0, 200.0 ],
									"style" : "",
									"text" : "Bonus round!\n\nCan you successfully connect the mouse input to control your paddle?\n\nYou will need: \n[mousestate]\n[scale]\n\nDon't forget to check the helpfile if you need!\n\n\nStyle points+++\nCan you hook up both X+Y axes of the paddles for 2D movement without any bugs? "
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 66.5, 307.0, 66.5, 307.0 ],
									"source" : [ "obj-14", 0 ]
								}
...
,
					"patching_rect" : [ 557.0, 460.0, 101.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 417.0, 158.0, 246.0, 200.0 ],
					"style" : "",
					"text" : "Challenge!\n\nCan you play with a friend via OSC? \n\nTeam up in groups of two. \n\nPick a port to send/receive on and use [UDPsend] & [UDPreceive] to move the paddles!\n\nOnce you complete this open up the bonus_round! subpatch and try the next challenge :)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 18.0, 159.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 191.0, 66.0, 22.0 ],
					"style" : "",
					"text" : "floating $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 503.0, 460.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					"color" : [ 0.117169, 0.892935, 0.166774, 1.0 ],
					"id" : "obj-81",
					"maxclass" : "newobj",
					"numinlets" : 0,
					"numoutlets" : 2,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 81.0, 64.0, 78.5, 22.0 ],
									"style" : "",
									"text" : "loadmess 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 81.0, 148.0, 47.0, 22.0 ],
									"style" : "",
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 156.5, 121.0, 63.0, 22.0 ],
									"style" : "",
									"text" : "r resetball"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 156.5, 232.0, 37.0, 22.0 ],
									"style" : "",
									"text" : "0 0 0"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "int" ],
													"patching_rect" : [ 210.5, 220.0, 30.0, 22.0 ],
													"style" : "",
													"text" : "t b i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 221.5, 266.0, 30.0, 22.0 ],
													"style" : "",
													"text" : "abs"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 170.5, 298.0, 29.5, 22.0 ],
													"style" : "",
													"text" : "+ 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 170.5, 326.0, 44.0, 22.0 ],
													"style" : "",
													"text" : "switch"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 170.5, 266.0, 46.0, 22.0 ],
													"style" : "",
													"text" : "decide"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "int" ],
													"patching_rect" : [ 78.0, 220.0, 30.0, 22.0 ],
													"style" : "",
													"text" : "t b i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 89.0, 266.0, 30.0, 22.0 ],
													"style" : "",
													"text" : "abs"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 38.0, 298.0, 29.5, 22.0 ],
													"style" : "",
													"text" : "+ 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 38.0, 326.0, 44.0, 22.0 ],
													"style" : "",
													"text" : "switch"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 38.0, 266.0, 46.0, 22.0 ],
													"style" : "",
													"text" : "decide"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 210.5, 182.0, 49.0, 22.0 ],
													"style" : "",
													"text" : "-"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 63.0, 182.0, 35.5, 22.0 ],
													"style" : "",
													"text" : "-"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 240.5, 140.0, 68.0, 22.0 ],
													"style" : "",
													"text" : "random 16"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 79.5, 140.0, 68.0, 22.0 ],
													"style" : "",
													"text" : "random 40"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 38.0, 413.0, 58.0, 22.0 ],
													"style" : "",
													"text" : "pack i i 0"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 38.0, 470.0, 30.0, 30.0 ],
													"style" : ""
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 63.0, 44.0, 30.0, 30.0 ],
													"style" : ""
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 210.5, 108.0, 61.0, 22.0 ],
													"style" : "",
													"text" : "random 8"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 63.0, 108.0, 68.0, 22.0 ],
													"style" : "",
													"text" : "random 20"
												}
...
, 											{
												"patchline" : 												{
													...
													"disabled" : 0,
													"hidden" : 0,
													"midpoints" : [ 72.5, 90.5, 250.0, 90.5 ],
													"order" : 0,
													"source" : [ "obj-1", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"disabled" : 0,
													"hidden" : 0,
													"midpoints" : [ 72.5, 90.5, 220.0, 90.5 ],
													"order" : 1,
													"source" : [ "obj-1", 0 ]
												}
...
,
									"patching_rect" : [ 81.0, 184.0, 74.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 109.0, 121.0, 43.0, 22.0 ],
									"style" : "",
									"text" : "sel 32"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 109.0, 93.0, 50.5, 22.0 ],
									"style" : "",
									"text" : "key"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 232.0, 102.0, 22.0 ],
									"style" : "",
									"text" : "impulse $1 $2 $3"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 156.5, 314.0, 30.0, 30.0 ],
									"style" : ""
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 166.0, 177.0, 90.5, 177.0 ],
									"source" : [ "obj-1", 0 ]
								}
...
,
					"patching_rect" : [ 191.0, 422.0, 65.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					"color" : [ 0.161527, 0.936769, 0.097315, 1.0 ],
					"id" : "obj-30",
					"linecount" : 2,
					"maxclass" : "newobj",
					"numinlets" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 152.0, 318.0, 54.0, 49.0 ],
									"style" : "",
									"text" : "s collisiongate"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 142.5, 222.0, 175.0, 22.0 ],
													"style" : "",
													"text" : "text $1, size 25, font arial black"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 142.5, 280.0, 332.0, 22.0 ],
													"style" : "",
													"text" : "jit.gl.text2d @color 0. 0. 1. 1. @position -14. -15. 0. @align 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 56.5, 11.0, 84.0, 22.0 ],
													"style" : "",
													"text" : "r collisiongate"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 56.5, 102.0, 34.0, 22.0 ],
													"style" : "",
													"text" : "gate"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 4,
													"outlettype" : [ "int", "", "", "int" ],
													"patching_rect" : [ 142.5, 171.0, 77.0, 22.0 ],
													"style" : "",
													"text" : "counter 1 21"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 56.5, 171.0, 65.0, 22.0 ],
													"style" : "",
													"text" : "s resetball"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 56.5, 147.0, 105.0, 22.0 ],
													"style" : "",
													"text" : "t b b"
												}
...
,
									"patching_rect" : [ 320.75, 390.0, 59.0, 62.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
,
									"style" : "",
									"text" : "p rightwall_collision_events"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 142.5, 218.0, 175.0, 22.0 ],
													"style" : "",
													"text" : "text $1, size 25, font arial black"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 142.5, 276.0, 328.0, 22.0 ],
													"style" : "",
													"text" : "jit.gl.text2d @color 1. 0. 0. 1. @position 13. -15. 0. @align 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 4,
													"outlettype" : [ "int", "", "", "int" ],
													"patching_rect" : [ 142.5, 167.0, 77.0, 22.0 ],
													"style" : "",
													"text" : "counter 1 21"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 56.5, 167.0, 65.0, 22.0 ],
													"style" : "",
													"text" : "s resetball"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "bang" ],
													"patching_rect" : [ 56.5, 143.0, 105.0, 22.0 ],
													"style" : "",
													"text" : "t b b"
												}
...
,
									"patching_rect" : [ 218.0, 390.0, 54.0, 62.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
,
									"style" : "",
									"text" : "p leftwall_collision_events"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 315.25, 485.0, 78.0, 47.0 ],
									"style" : "",
									"text" : "blue point++\nreset ball\n321?"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 209.5, 485.0, 73.5, 47.0 ],
									"style" : "",
									"text" : "red point++\nreset ball\n321?"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 801.75, 508.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 700.0, 508.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 596.25, 478.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 493.5, 440.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 389.25, 440.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 286.5, 440.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 733.25, 457.0, 156.0, 22.0 ],
									"style" : "",
									"text" : "regexp pongball_wallbody5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 630.5, 429.0, 156.0, 22.0 ],
									"style" : "",
									"text" : "regexp pongball_wallbody4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 527.75, 403.0, 156.0, 22.0 ],
									"style" : "",
									"text" : "regexp pongball_wallbody3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 425.0, 375.0, 156.0, 22.0 ],
									"style" : "",
									"text" : "regexp pongball_wallbody2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 320.75, 345.0, 156.0, 22.0 ],
									"style" : "",
									"text" : "regexp pongball_wallbody1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 218.0, 317.0, 156.0, 22.0 ],
									"style" : "",
									"text" : "regexp pongball_wallbody0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 434.0, 22.5, 317.0, 123.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 108.0, 151.0, 49.0, 22.0 ],
									"style" : "",
									"text" : "dict.iter"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 174.0, 151.0, 150.0, 20.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 42.5, 129.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 42.5, 159.0, 34.0, 22.0 ],
									"style" : "",
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 174.0, 287.0, 573.0, 20.0 ],
									"style" : "",
									"text" : "we'll use that value to open a gate and let through ONLY the initial collision when triggering the next event"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 194.0, 263.0, 511.0, 20.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 237.0, 213.0, 514.0, 47.0 ],
									"style" : "",
									"text" : "we're going to iterate through the subdictionaries in search of duration data for the ball. The duration lets us know the two things collide for the *first* time (since our render is running, the objects may be in contact for longer than the rate at which the render is clocked)."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 152.0, 263.0, 38.0, 22.0 ],
									"style" : "",
									"text" : "== 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 152.0, 239.0, 85.0, 22.0 ],
									"style" : "",
									"text" : "route duration"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 152.0, 213.0, 49.0, 22.0 ],
									"style" : "",
									"text" : "dict.iter"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 108.0, 184.0, 63.0, 23.0 ],
									"style" : "",
									"text" : "zl.slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 42.5, 184.0, 56.0, 22.0 ],
									"style" : "",
									"text" : "dict.print"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 108.0, 73.0, 90.0, 22.0 ],
									"style" : "",
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 117.5, 313.5, 227.5, 313.5 ],
									"source" : [ "obj-50", 0 ]
								}
...
,
					"patching_rect" : [ 191.0, 494.0, 65.0, 35.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 47.0, 62.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 84.0, 109.0, 150.0, 24.0 ],
									"style" : "",
									"text" : "turn on/off visible walls"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 47.0, 109.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 216.0, 459.0, 630.0, 22.0 ],
									"style" : "",
									"text" : "jit.phys.body @shape cube @scale 25 0 25 @position 0. -25 0. @mass 0 @friction 0. @damping 0. 0. @restitution 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 212.0, 378.0, 626.0, 22.0 ],
									"style" : "",
									"text" : "jit.phys.body @shape cube @scale 25 0 25 @position 0. 25 0. @mass 0 @friction 0. @damping 0. 0. @restitution 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 212.0, 176.0, 633.0, 22.0 ],
									"style" : "",
									"text" : "jit.phys.body @shape cube @scale 0 25 25 @position -25. 0. 0. @mass 0 @friction 0. @damping 0. 0. @restitution 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 212.0, 268.0, 629.0, 22.0 ],
									"style" : "",
									"text" : "jit.phys.body @shape cube @scale 0 25 25 @position 25. 0. 0. @mass 0 @friction 0. @damping 0. 0. @restitution 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 144.0, 460.0, 70.0, 20.0 ],
									"style" : "",
									"text" : "bottom wall"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 144.0, 378.0, 56.0, 20.0 ],
									"style" : "",
									"text" : "top wall"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 148.0, 268.0, 56.0, 20.0 ],
									"style" : "",
									"text" : "right wall"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 152.0, 177.0, 56.0, 20.0 ],
									"style" : "",
									"text" : "left wall"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 47.0, 176.0, 92.5, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 47.0, 207.0, 360.0, 22.0 ],
									"style" : "",
									"text" : "jit.gl.gridshape @shape cube @scale 0 25 25 @position -25. 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 47.0, 268.0, 92.5, 22.0 ],
									"style" : "",
									"text" : "jit.gl.material"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 47.0, 298.0, 356.0, 22.0 ],
									"style" : "",
									"text" : "jit.gl.gridshape @shape cube @scale 0 25 25 @position 25. 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 51.0, 460.0, 92.5, 22.0 ],
									"style" : "",
									"text" : "jit.gl.material"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 51.0, 491.0, 357.0, 22.0 ],
									"style" : "",
									"text" : "jit.gl.gridshape @shape cube @scale 25 0 25 @position 0. -25 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 47.0, 376.0, 92.5, 22.0 ],
									"style" : "",
									"text" : "jit.gl.material"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 47.0, 407.0, 353.0, 22.0 ],
									"style" : "",
									"text" : "jit.gl.gridshape @shape cube @scale 25 0 25 @position 0. 25 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 53.0, 595.0, 458.0, 22.0 ],
									"style" : "",
									"text" : "jit.phys.ghost @shape cube @scale 25. 5. 25. @position 0. -20. 0. @force 0. 200. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 539.0, 539.0, 156.0, 64.0 ],
									"style" : "",
									"text" : "phys.ghosts to get around \n0 gravity (repel ball from top and bottom walls)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 266.0, 522.0, 244.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 53.0, 560.0, 458.0, 22.0 ],
									"style" : "",
									"text" : "jit.phys.ghost @shape cube @scale 25. 5. 25. @position 0. 20. 0. @force 0. -200. 0."
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 221.5, 403.0, 56.5, 403.0 ],
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 225.5, 485.5, 60.5, 485.5 ],
									"source" : [ "obj-11", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 221.5, 294.0, 56.5, 294.0 ],
									"source" : [ "obj-8", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 221.5, 202.0, 56.5, 202.0 ],
									"source" : [ "obj-9", 0 ]
								}
...
,
					"patching_rect" : [ 503.0, 494.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					"color" : [ 0.936904, 0.0, 0.999048, 1.0 ],
					"id" : "obj-16",
					"maxclass" : "newobj",
					"numinlets" : 0,
					"numoutlets" : 0,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 50.0, 274.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 304.0, 45.0, 22.0 ],
									"style" : "",
									"text" : "fontlist"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 137.0, 186.0, 240.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 137.0, 420.0, 22.0 ],
									"style" : "",
									"text" : "text OSC_PONG || Interactive Systems Design ARCH1479, size 12, font arial"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 235.0, 308.0, 22.0 ],
									"style" : "",
									"text" : "jit.gl.text2d @color 1 1 1 1 @align 1 @position 0. -15. 0."
								}
...
,
					"patching_rect" : [ 557.0, 494.0, 101.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 178.0, 191.0, 179.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.camera @position 0. 0. 45."
				}

			}
, 			{
				"box" : 				{
					"color" : [ 0.109879, 0.838627, 0.237796, 1.0 ],
					"id" : "obj-44",
					"maxclass" : "newobj",
					"numinlets" : 3,
					"numoutlets" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 857.0, 275.5, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 236.0, 90.0, 225.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 236.0, 118.0, 225.0, 23.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 236.0, 143.0, 225.0, 23.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 131.0, 107.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 32.0, 167.0, 54.0, 22.0 ],
									"style" : "",
									"text" : "pak f f"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 31.0, 238.0, 845.0, 22.0 ],
									"style" : "",
									"text" : "jit.phys.body @name pongball @shape sphere @scale 0.3 1 1 @position 0. 0. 0. @rotatexyz 0. 0. 0 @collisions 1 @restitution 1 @friction 0. @damping 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 31.0, 205.0, 95.0, 22.0 ],
									"style" : "",
									"text" : "position $1 $2 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 31.0, 279.0, 412.0, 23.0 ],
									"style" : "",
									"text" : "jit.gl.gridshape @shape sphere @scale 0.5 1 1 1 @color 0.5 0.9 0.5 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 67.0, 107.0, 30.0, 30.0 ],
									"style" : ""
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 140.5, 195.0, 40.5, 195.0 ],
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 245.5, 199.0, 40.5, 199.0 ],
									"source" : [ "obj-56", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 245.5, 202.0, 40.5, 202.0 ],
									"source" : [ "obj-57", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 245.5, 201.5, 40.5, 201.5 ],
									"source" : [ "obj-58", 0 ]
								}
...
,
					"patching_rect" : [ 191.0, 461.0, 65.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 427.0, 431.0, 21.0, 20.0 ],
					"style" : "",
					"text" : ":y"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 378.0, 430.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					"color" : [ 0.985948, 0.0, 0.026951, 1.0 ],
					"id" : "obj-39",
					"maxclass" : "newobj",
					"numinlets" : 2,
					"numoutlets" : 0,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 262.0, 538.0, 200.0 ],
									"style" : "",
									"text" : "Bonus round!\n\nCan you successfully connect the mouse input to control your paddle?\n\nYou will need: \n[mousestate]\n[scale]\n\nDon't forget to check the helpfile if you need!\n\n\nStyle points+++\nCan you hook up both axes of the paddles without any bugs? "
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 171.0, 541.0, 35.0 ],
									"style" : "",
									"text" : "jit.phys.body @shape cube @scale 0.2 1.5 1 @position 24. 0. 0. @rotatexyz 0. -28. 0 @collisions 1 @restitution 1 @mass 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 138.0, 95.0, 22.0 ],
									"style" : "",
									"text" : "position $1 $2 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 50.0, 212.0, 357.0, 23.0 ],
									"style" : "",
									"text" : "jit.gl.gridshape @shape cube @scale 0.2 1 1 @color 1 0 0 0"
								}
...
,
					"patching_rect" : [ 316.0, 494.0, 81.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					"color" : [ 0.050189, 0.407133, 0.998381, 1.0 ],
					"id" : "obj-38",
					"maxclass" : "newobj",
					"numinlets" : 2,
					"numoutlets" : 0,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 171.0, 541.0, 35.0 ],
									"style" : "",
									"text" : "jit.phys.body @shape cube @scale 0.2 1.5 1 @position -24. 0. 0. @rotatexyz 0. 25. 0 @collisions 1 @restitution 1 @mass 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 50.0, 221.0, 375.0, 23.0 ],
									"style" : "",
									"text" : "jit.gl.gridshape @shape cube @scale 0.2 1 1 @color 0. 0.5 1. 1"
								}
...
,
					"patching_rect" : [ 32.0, 494.0, 71.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 133.0, 430.0, 21.0, 20.0 ],
					"style" : "",
					"text" : ":y"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 17.0, 77.0, 74.0, 23.0 ],
					"style" : "",
					"text" : "t b erase"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 17.0, 13.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 17.0, 45.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 33"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 17.0, 226.0, 340.0, 22.0 ],
					"style" : "",
					"text" : "jit.window pong @fsaa 1 @size 640 480 @floating 1 @grow 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 17.0, 115.0, 642.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.render pong @ortho 1 @lens_angle 120 @camera 0 0 -25 @lighting_enable 1 @light_position 445. 445. 445. -10."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 184.0, 77.0, 475.0, 35.0 ],
					"style" : "",
					"text" : "jit.phys.world @worldbox 1 @worldbox_scale 25 20 25 @gravity 0 0 0 @remove_plane 3"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 193.5, 113.0, 26.5, 113.0 ],
					"source" : [ "obj-1", 0 ]
				}
